 ...
 * Run this once with: node fix.js
 */
...
try {
  ...
  if (fs.existsSync(viteConfigPath)) {
    ...
    // Check if it contains import.meta.dirname
    if (content.includes('import.meta.dirname')) {
      console.log('Fixing import.meta.dirname issue...');
      
      // Add __dirname equivalent for ESM
...
const __dirname = path.dirname(__filename);`
      ...
      console.log('✅ vite.config.ts already fixed or does not need fixing.');
    }
  } else {
